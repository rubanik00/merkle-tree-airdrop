...
import {AirdropTokenTest} from "./utils/AirdropTokenTest.sol"; // Test scaffolding

/// @title Tests
/// @notice AirdropToken tests
contract Tests is AirdropTokenTest {
    /// @notice Allow Alice to claim 100e18 tokens
    function testAliceClaim() public {
        // Setup correct proof for Alice
        bytes32[] memory aliceProof = new bytes32[](1);
        aliceProof[0] = 0x6c877f3788a93cc7b599ceff4ae6285c7a4967eafcaa0e7b55f1f05d9de0b8ed;
